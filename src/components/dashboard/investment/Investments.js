      ...
      <Styled.Wrapper>
        <Styled.Section sx="compliance__wrapper">
          ...
          <Styled.Wrapper sx="flex justify-center items-center gap-[8px] ">
            ...
            <TransaSort name="PDF" onClick={() => exportToPDF(allInvestments, "Funding Report", invest_col, "landscape")} />
            <TransaSort name="EXCEL" onClick={() => exportToExcel(allInvestments, "Funding Report", invest_col)} />
